...
| Класс | В нашей миграции? | Комментарий |
|-------|:-----------------:|-------------|
| UI-история чата / события | [да / нет] | видимая лента |
| Контекст агента (checkpoint) | [нет — таблицы фреймворка / да — свои] | не путать с UI-историей |
| Реестр агент-конфигов | [нет — код / да — таблица] | |
| Домен внешней системы | [нет] | не копировать в свою БД без нужды |
