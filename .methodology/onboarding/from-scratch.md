...
> **Расширенный вариант** (есть ТЗ/PoC, веб-UI, cloud-агент): [from-scratch-v2.md](from-scratch-v2.md).
...
--- ШАГ 10: Skills стека ---
Поставляемые skills уже должны быть в .agents/skills/ (копия из .methodology/skills/).
По .methodology/rules/40-skills-router.mdc выпиши остальные skills выбранного стека.
Каждый должен открываться Read по пути .agents/skills/<name>/SKILL.md.
Нет файла — сначала .methodology/skills/, затем ~/.agents/skills/ или ~/.cursor/skills/.
Строка в таблице есть, файла нет — стоп, не иди «по здравому смыслу».
...
- [ ] skills стека установлены в `.agents/skills/` и открываются по роутеру
